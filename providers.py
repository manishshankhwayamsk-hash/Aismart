...
async def generate_quiz_json(provider: str, key: str, extra: str | None, topic: str) -> dict:
    """
    Asks the AI for one multiple-choice question as strict JSON:
    {"question": str, "options": [str, str, str, str], "correct_index": int}
    """
    prompt = (
        f"Create ONE multiple-choice quiz question about the cybersecurity topic: "
        f"'{topic}'. Respond with ONLY raw JSON, no markdown fences, no extra text, "
